...
(function () {
  ...
  if (website_host == "iopscience.iop.org") {
    ...
    insertdom.append(p);
    insertnode.prepend(insertdom);
  } else if (website_host == "www.science.org") {
    let doimeta = document.querySelector("meta[scheme='doi']");
    let doi = doimeta.content;
    let insertnode = document.getElementsByClassName("info-panel__right-content")[0];
    let insertdom = document.createElement("li");
    let p = document.createElement("a");
    let ico = document.createElement("img");
    ico.src = "data:image/png;base64,";
